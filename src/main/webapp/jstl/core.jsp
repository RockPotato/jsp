...
<%--
   jstl을 사용하기 위한 준비 : jsp 디렉티브 (taglib)을 이용하여 사용하고자 하는 라이브러리 선언
...
<body>
	...
	<%-- pageContext.setAttribute("userId", "brown"); 과 동일한 의미 
 ...
 --%>
	...
	<c:if test="${code == '00' }">
		<span>code가 00 값 입니다.</span>
	</c:if>

	<c:if test="${code == '01' }">
		<span>code가 01 값 입니다.</span>
	</c:if>
