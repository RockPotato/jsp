...
public class NowServlet extends HttpServlet{
	...
	* @throws IOException
	* Method 설명 : 동적으로 현재 시간을 출력해주는 html을 생성
	 */
//	doGet : http메소드중 get 메소드 요청을 처리
//	get :	1. 웹 브라우저에서 주소줄에 입력 : get 요첟
//			2. <a> 태그 href 속성에 설정된 주소 : get 요청
//	post :	1. form tag안에 있는 input 태그중 type="submit"으로 되어있을 경우
//			2. javascript로 post 전송을 강제한 경우
	
//	doGet :	get 요청에 대해 처리해주는 메소드
